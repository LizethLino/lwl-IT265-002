...
- [ ] Goal 2: Think of simplifying/streamlining my story concept
- [ ] Goal 3: How do card games work,,,,,,,,,,,,,,,,,,,,,,,,,,,,,

#### Progress
- **What I accomplished**:
  - Summarize completed tasks or progress made.
  - I've begun practicing my art and I've been able to make some nice full body sketches, so hopefully I'll be able to draw my own card designs.
  - I played that atari game Crypts of Chaos and man is it confusing. I'll be honest I do not know old games, so I was so lost in the beginning. I'll be writing up my case study after this now that I was able to play the game.
- **Challenges faced**:
  - Describe blockers, bugs, or issues encountered.
  - If I want my concept to be around my story I will likely need to either group parts of the story into chapters or create a concrete end. Since my story is just for my own enjoyment it's a convoluted mess which would likely make for a very tiring or overwhelming game experience.
- **Solutions**:
  - Detail how you addressed challenges or your thought process.
  -  I'm planning on organizing the important parts of my story. I saw some websites that help you make timelines for events, so I'll probably use those to make it easier for myself.

#### Learnings
- Key insights, techniques, or concepts explored.
- N/A (still not really sure what that means,,,,,)

#### Free Thinking
- Brainstorm or reflect on design ideas, architecture patterns, or potential improvements.
-  In terms of concepts I was thinking for my story I could have a split betweeen day and night. Day would be free roam and allow you to interact with characters and learn new things. You could also find new cards hidden around the area. When the day ends, the main character will go to sleep and find themselves in a card game against someone who seems to know them. I'm thinking what could make this interesting is if you are allowed to freely ask this person questions but that would be,,,, very difficult. Ideally the goal of this game is for the player to find the mc's identity and the identity of the person in your dreams. There should be a disconnect between the player and the main character. The mc knows who they are but the player does not. Their goals should not align. At least, if the person I'm thinking of making the mc does end up being them. It might be more interesting to make it someone else. Or make it someone new to take the place of the player who truly knows nothing.
